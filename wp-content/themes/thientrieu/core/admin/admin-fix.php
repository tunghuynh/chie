<?php 
	...
	function custom_dashboard_help() { ?>
	    ...
	    <p>Hệ thống được phát triển bởi <a href="http://tunghuynh.net/"><strong>tunghuynh.net</strong></a></p>
	    <p>Mọi yêu cầu, hỗ trợ quý khách hàng có thể liên hệ <strong>Developers</strong></p>
	    <p><strong>Điện thoại</strong>: </p>
	    <p><strong>Email</strong>: tunghuynh.tn@gmail.com - <strong>Website</strong>: <a href="http://tunghuynh.net/"><strong>tunghuynh.net</strong></a></p>
	    <p><strong>Cảm ơn quý khách đã tin tưởng và sử dụng sản phẩm của Tùng Huynh.</strong></p>
	<?php }
